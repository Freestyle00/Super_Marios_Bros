...
{
    public partial class Lucky_block : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static Microsoft.Xna.Framework.Graphics.Texture2D luckyblocknormal;
        protected static Microsoft.Xna.Framework.Graphics.Texture2D luckyblockhasbeentouched;
        ...
        public Lucky_block (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Lucky_block (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void UnloadStaticContent () 
        {
            ...
            if (LoadedContentManagers.Count == 0)
            {
                if (luckyblocknormal != null)
                {
                    luckyblocknormal= null;
                }
                if (luckyblockhasbeentouched != null)
                {
                    luckyblockhasbeentouched= null;
                }
            }
        }
        ...
        public static object GetStaticMember (string memberName) 
        {
            switch(memberName)
            {
                case  "luckyblocknormal":
                    return luckyblocknormal;
                case  "luckyblockhasbeentouched":
                    return luckyblockhasbeentouched;
            }
            return null;
        }
