...
using System.Text;
using Super_Marios_Bros.DataTypes;
using FlatRedBall.IO.Csv;
namespace Super_Marios_Bros.Entities
{
    public partial class Mario : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        private FlatRedBall.Math.Geometry.AxisAlignedRectangle mDieThing;
        public FlatRedBall.Math.Geometry.AxisAlignedRectangle DieThing
        {
            get
            {
                return mDieThing;
        ...
        public virtual Super_Marios_Bros.DataTypes.PlatformerValues GroundMovement
        {
            set
            {
        ...
        public event Action<Super_Marios_Bros.DataTypes.PlatformerValues> BeforeAirMovementSet;
        public event System.EventHandler AfterAirMovementSet;
        private Super_Marios_Bros.DataTypes.PlatformerValues mAirMovement;
        public virtual Super_Marios_Bros.DataTypes.PlatformerValues AirMovement
        {
            set
            {
        ...
        public event Action<Super_Marios_Bros.DataTypes.PlatformerValues> BeforeAfterDoubleJumpSet;
        public event System.EventHandler AfterAfterDoubleJumpSet;
        private Super_Marios_Bros.DataTypes.PlatformerValues mAfterDoubleJump;
        public virtual Super_Marios_Bros.DataTypes.PlatformerValues AfterDoubleJump
        {
            set
            {
        ...
        public Mario (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Mario (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        protected virtual void InitializeEntity (bool addToManagers) 
        {
            ...
            mDieThing = new FlatRedBall.Math.Geometry.AxisAlignedRectangle();
            mDieThing.Name = "mDieThing";
        ...
        public virtual void ReAddToManagers (FlatRedBall.Graphics.Layer layerToAddTo) 
        {
            ...
            FlatRedBall.Math.Geometry.ShapeManager.AddToLayer(mDieThing, LayerProvidedByContainer);
        }
        ...
        public virtual void Destroy () 
        {
            if (Used)
            {
                Factories.MarioFactory.MakeUnused(this, false);
            }
            ...
            if (DieThing != null)
            {
                FlatRedBall.Math.Geometry.ShapeManager.RemoveOneWay(DieThing);
            }
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("MarioStaticUnload", UnloadStaticContent);
                ...
                {
                    {
                        ...
                        System.Collections.Generic.Dictionary<System.String, Super_Marios_Bros.DataTypes.PlatformerValues> temporaryCsvObject = new System.Collections.Generic.Dictionary<System.String, Super_Marios_Bros.DataTypes.PlatformerValues>();
                        FlatRedBall.IO.Csv.CsvFileManager.CsvDeserializeDictionary<System.String, Super_Marios_Bros.DataTypes.PlatformerValues>("content/entities/mario/platformervaluesstatic.csv", temporaryCsvObject, FlatRedBall.IO.Csv.DuplicateDictionaryEntryBehavior.Replace);
        ...
        public virtual void SetToIgnorePausing () 
        {
            ...
            FlatRedBall.Instructions.InstructionManager.IgnorePausingFor(DieThing);
        }
        ...
        public virtual void MoveToLayer (FlatRedBall.Graphics.Layer layerToMoveTo) 
        {
            ...
            if (layerToRemoveFrom != null)
            {
                layerToRemoveFrom.Remove(DieThing);
            }
            FlatRedBall.Math.Geometry.ShapeManager.AddToLayer(DieThing, layerToMoveTo);
